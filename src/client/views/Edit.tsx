...
const Edit = () => {
  ...
  const handleUpdate = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (!blog_content || !blog_title || !selectedTagId)
      return alert('please complete all fields to confirm your update (check tag selection)'); // need UI update
  ...
  useEffect(() => {
    APIService(`/api/blogs/${blog_id}`)
      .then((data) => {
        //had to remove:(data: BlogTagsJoined) due to error
        data = data[0];
        setBlog(data);
    ...
    <>
      ...
      <div className="row mt-5 justify-content-center">
        <div className="form-group col-6">
          ...
          <select
            value={selectedTagId}
            onChange={handleTagSelectUpdate}
          ...
          <div
            className="form-control input-group-text m-2 justify-content-left"
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setBlogContent(e.target.value)}
          >
            <textarea
          ...
          <div className="m-2">
            ...
            <button onClick={handleDelete} className="btn mx-2 btn-danger">
              Delete!
            </button>
