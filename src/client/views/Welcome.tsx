  ...
  return (
    <>
      <div className="row justify-content-center">
        ...
        <p>
          Check your inbox for a confirmation message from me with a special surpise😝, it should
          arrive in the next few minutes. If you don’t receive it soon, please check your junk mail
          or spam folder. Sometimes the message gets stuck there. Hope you enjoy your free content
          I've put together along with some other awesome bonuses that will be coming your way. 
        </p>
          ...
          <div key={`blog-${blog.id}-${blog.authorid}`} className="container">
            <div className="card col-12 col-md-6 shadow-lg m-3">
              <h5 className="card-header">
                Featured Blog #: {blog.id} | Author ID: {blog.authorid}{' '}
              </h5>
